            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('gejala.update', $isi->id) }}" method="POST" data-parsley-validate>
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            placeholder="Kode Gejala" value="{{ $isi->kode_gejala }}" data-parsley-required="true" data-parsley-required-message="Kode gejala tidak boleh kosong">
                                            @error('kode_gejala')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            value="{{ $isi->nama_gejala }}" placeholder="Deskripsi Gejala" data-parsley-required="true" data-parsley-required-message="Nama gejala tidak boleh kosong">
                                        </div>
                                    </div>
